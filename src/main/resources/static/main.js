...
/* harmony import */ var _components_video_session3D_video_session3d_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/video-session3D/video-session3d.component */ "./src/app/components/video-session3D/video-session3d.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _components_video_session3D_video_session3d_component__WEBPACK_IMPORTED_MODULE_22__["VideoSession3DComponent"],
...
/* harmony import */ var _components_video_session3D_video_session3d_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/video-session3D/video-session3d.component */ "./src/app/components/video-session3D/video-session3d.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'lesson/:id/3D',
        component: _components_video_session3D_video_session3d_component__WEBPACK_IMPORTED_MODULE_7__["VideoSession3DComponent"],
        canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]],
        data: { state: 'session' }
    },
];
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.goToLesson3D = function (lesson) {
        var _this = this;
        this.videoSessionService.lesson = lesson;
        if (this.authenticationService.isTeacher()) {
            var dialogRef = void 0;
            ...
            dialogRef.afterClosed().subscribe(function (cameraOptions) {
                if (!!cameraOptions) {
                    ...
                    console.log(cameraOptions);
                    _this.videoSessionService.cameraOptions = cameraOptions;
                    _this.router.navigate(['/lesson/' + lesson.id + '/3D']);
                }
            });
        }
        else {
...
var VideoSessionComponent = /** @class */ (function () {
    ...
    VideoSessionComponent.prototype.switchVideo = function () {
        var _this = this;
        ...
        this.OV.getUserMedia({
            ...
            var newTrack = mediaStream.getVideoTracks()[0];
            _this.publisher.replaceTrack(newTrack);
        });
    };
...
/***/ "./src/app/components/video-session3D/video-session3d.component.css":
/*!**************************************************************************!*\
  !*** ./src/app/components/video-session3D/video-session3d.component.css ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = "h1 {\n  text-align: center;\n  margin: 0;\n  color: white;\n}\n\n#header-div {\n  position: absolute;\n  z-index: 1000;\n  width: 100%;\n  background: rgba(0, 0, 0, 0.4);\n  -webkit-touch-callout: none;\n  /* iOS Safari */\n  -webkit-user-select: none;\n  /* Safari */\n  /* Konqueror HTML */\n  -moz-user-select: none;\n  /* Firefox */\n  -ms-user-select: none;\n  /* Internet Explorer/Edge */\n  user-select: none;\n}\n\nmat-icon {\n  font-size: 38px;\n  width: 38px;\n  height: 38px;\n  color: white;\n  transition: color .2s linear;\n}\n\nmat-icon:hover {\n  color: #ffd740;\n}\n\n#back-btn {\n  float: left;\n}\n\n.right-btn {\n  float: right;\n}\n\n#info{\n\tpadding:10px;\n\tcolor:#fff;\n\tposition:absolute;\n\tbackground-color:rgba(0,0,0,0.4);\n  }\n\n#help-text H1 {\n\tfont-size:18px;\n\tmargin-top:15px;\n\n  }\n\n#help-text DIV{\n\tmargin-bottom:5px;\n  }\n\n#help-text DIV LABEL{\n\tdisplay:inline-block;\n\twidth:160px;\n  }\n\n#help-text SECTION {\n\tmargin-top:20px;\n  }\n\n#generic_error,\n  #security_error{\n\tpadding-top:200px;\n\twidth:500px;\n\tmargin-left:auto;\n\tmargin-right:auto;\n\tdisplay:none;\n  }\n\n#logo {\n    width:50px;\n    height:50px;\n    padding:10px;\n    position:absolute;\n    top:0px;\n    right:0px;\n    cursor:pointer;\n    background-color:rgba(0,0,0,0.4);\n    background-image:url('oculus_bridge.png');\n    background-repeat:no-repeat;\n    background-position:10px 10px;\n  }\n\n#logo.offline{\n    background-image:url('oculus_bridge_offline.png');\n  }\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/components/video-session3D/video-session3d.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/components/video-session3D/video-session3d.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
var ovr = __webpack_require__(/*! openvidu-vr-library */ "./node_modules/openvidu-vr-library/index.js").OVVR;
var VideoSession3DComponent = /** @class */ (function () {
    function VideoSession3DComponent(location, authenticationService, videoSessionService, snackBar) {
        this.location = location;
        this.authenticationService = authenticationService;
        this.videoSessionService = videoSessionService;
        this.snackBar = snackBar;
    ...
    VideoSession3DComponent.prototype.OPEN_VIDU_CONNECTION = function () {
        // 0) Obtain 'token' from server
        // In this case, the method ngOnInit takes care of it
        var _this = this;
        // 1) Initialize OpenVidu and your Session
        ...
        this.session.on('connectionCreated', function (event) {
            if (event.connection.connectionId === _this.session.connection.connectionId) {
                ...
                console.warn('is teacher!', _this.authenticationService.connectionBelongsToTeacher(event.connection));
                if (!_this.authenticationService.connectionBelongsToTeacher(event.connection)) {
                    console.warn('creating student box!');
                    _this.OVVr.createStudentBox();
                }
            }
            console.warn(event.connection);
        });
        this.session.on('connectionDestroyed', function (event) {
            ...
            console.warn(event.connection);
            if (_this.authenticationService.connectionBelongsToTeacher(event.connection)) {
                _this.OVVr.removeTeacherBox();
                _this.location.back();
                return;
            }
            _this.OVVr.removeStudentBox();
        });
        // 3) Connect to the session
        this.session.connect(this.token, 'CLIENT:' + this.authenticationService.getCurrentUser().name)
            .then(function () {
            if (_this.authenticationService.isTeacher()) {
                // 4) Get your own camera stream with the desired resolution and publish it, only if the user is supposed to do so
                _this.publisher = _this.OV.initPublisher('video', _this.cameraOptions);
                console.warn("INIT THREEJS teacher");
                _this.OVVr.init(_this.PUBLISHER);
                _this.OVVr.animate();
                _this.publisher.on('streamCreated', function (event) {
                    console.warn('STREAM CREATED BY PUBLISHER!');
                    console.warn(event.stream);
    ...
    VideoSession3DComponent.prototype.switchVideo = function () {
        var _this = this;
        var videosource = undefined;
        if (!this.screenActive) {
            videosource = 'screen';
    ...
    VideoSession3DComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Specific aspects of this concrete application
        this.previousConnectionStuff();
        if (this.authenticationService.isTeacher()) {
            ...
            this.videoSessionService.generateToken(this.lesson.id).subscribe(function (response) {
                ...
                _this.OVVr.init(_this.SUBSCRIBER);
                _this.OVVr.animate();
                _this.OPEN_VIDU_CONNECTION();
            }, function (error) {
                console.log(error);
    ...
    VideoSession3DComponent.prototype.ngAfterViewInit = function () {
        this.toggleScrollPage('hidden');
    };
    VideoSession3DComponent.prototype.ngOnDestroy = function () {
        this.videoSessionService.removeUser(this.lesson.id).subscribe(function (response) {
            console.warn('You have succesfully left the lesson');
        }, function (error) {
            console.log(error);
    ...
    VideoSession3DComponent.prototype.toggleScrollPage = function (scroll) {
        var content = document.getElementsByClassName('mat-sidenav-content')[0];
        content.style.overflow = scroll;
    };
    VideoSession3DComponent.prototype.toggleLocalVideo = function () {
        this.localVideoActivated = !this.localVideoActivated;
        this.publisher.publishVideo(this.localVideoActivated);
        this.videoIcon = this.localVideoActivated ? 'videocam' : 'videocam_off';
    };
    VideoSession3DComponent.prototype.toggleLocalAudio = function () {
        this.localAudioActivated = !this.localAudioActivated;
        this.publisher.publishAudio(this.localAudioActivated);
        this.audioIcon = this.localAudioActivated ? 'mic' : 'mic_off';
    };
    VideoSession3DComponent.prototype.toggleFullScreen = function () {
        var document = window.document;
        var fs = document.getElementsByTagName('html')[0];
        if (!document.fullscreenElement &&
            !document.mozFullScreenElement &&
    ...
    VideoSession3DComponent.prototype.exitFullScreen = function () {
        var document = window.document;
        var fs = document.getElementsByTagName('html')[0];
        if (document.exitFullscreen) {
            document.exitFullscreen();
    ...
    VideoSession3DComponent.prototype.previousConnectionStuff = function () {
        this.lesson = this.videoSessionService.lesson;
        this.cameraOptions = this.videoSessionService.cameraOptions;
    };
    VideoSession3DComponent.prototype.afterConnectionStuff = function () {
        if (this.authenticationService.isTeacher()) {
            this.localVideoActivated = this.cameraOptions.publishVideo !== false;
            this.localAudioActivated = this.cameraOptions.publishAudio !== false;
            this.videoIcon = this.localVideoActivated ? 'videocam' : 'videocam_off';
    ...
    VideoSession3DComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-video-session-3d',
            template: __webpack_require__(/*! ./video-session3d.component.html */ "./src/app/components/video-session3D/video-session3d.component.html"),
            styles: [__webpack_require__(/*! ./video-session3d.component.css */ "./src/app/components/video-session3D/video-session3d.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_0__["Location"],
            _services_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"],
            _services_video_session_service__WEBPACK_IMPORTED_MODULE_5__["VideoSessionService"],
    ...
    return VideoSession3DComponent;
}());
...
module.exports = __webpack_require__(/*! /home/carlos/CODEURJC/classroom-demo/src/angular/frontend/src/main.ts */"./src/main.ts");
