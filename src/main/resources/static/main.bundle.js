...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            animations: [__WEBPACK_IMPORTED_MODULE_3__router_animation__["a" /* routerTransition */]]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_presentation_presentation_component__ = __webpack_require__("./src/app/components/presentation/presentation.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_dashboard_dahsboard_component__ = __webpack_require__("./src/app/components/dashboard/dahsboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_lesson_details_lesson_details_component__ = __webpack_require__("./src/app/components/lesson-details/lesson-details.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_video_session_video_session_component__ = __webpack_require__("./src/app/components/video-session/video-session.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_dashboard_join_session_dialog_component__ = __webpack_require__("./src/app/components/dashboard/join-session-dialog.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__services_lesson_service__ = __webpack_require__("./src/app/services/lesson.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__services_video_session_service__ = __webpack_require__("./src/app/services/video-session.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__components_presentation_presentation_component__["a" /* PresentationComponent */],
                __WEBPACK_IMPORTED_MODULE_12__components_dashboard_dahsboard_component__["a" /* DashboardComponent */],
                __WEBPACK_IMPORTED_MODULE_13__components_lesson_details_lesson_details_component__["a" /* LessonDetailsComponent */],
                __WEBPACK_IMPORTED_MODULE_14__components_profile_profile_component__["a" /* ProfileComponent */],
                __WEBPACK_IMPORTED_MODULE_15__components_video_session_video_session_component__["a" /* VideoSessionComponent */],
                __WEBPACK_IMPORTED_MODULE_16__components_error_message_error_message_component__["a" /* ErrorMessageComponent */],
                __WEBPACK_IMPORTED_MODULE_17__components_dashboard_join_session_dialog_component__["a" /* JoinSessionDialogComponent */],
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_20__services_lesson_service__["a" /* LessonService */],
                __WEBPACK_IMPORTED_MODULE_21__services_video_session_service__["a" /* VideoSessionService */],
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__services_lesson_service__["a" /* LessonService */],
            __WEBPACK_IMPORTED_MODULE_5__services_video_session_service__["a" /* VideoSessionService */],
            __WEBPACK_IMPORTED_MODULE_6__services_authentication_service__["a" /* AuthenticationService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_2__angular_material__["j" /* MatSnackBar */],
...
var ErrorMessageComponent = /** @class */ (function () {
    function ErrorMessageComponent() {
        this.eventShowable = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
    }
...
var LessonDetailsComponent = /** @class */ (function () {
    ...
    LessonDetailsComponent.prototype.deleteLessonAttender = function (i, attender) {
        ...
        for (var j = 0; j < this.lesson.attenders.length; j++) {
            if (this.lesson.attenders[j].id !== attender.id) {
                ...
                l.attenders.push(new __WEBPACK_IMPORTED_MODULE_5__models_user__["a" /* User */](this.lesson.attenders[j]));
            }
        }
    ...
    LessonDetailsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__services_lesson_service__["a" /* LessonService */],
            __WEBPACK_IMPORTED_MODULE_7__services_authentication_service__["a" /* AuthenticationService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_2__angular_common__["f" /* Location */],
            __WEBPACK_IMPORTED_MODULE_3__angular_material__["j" /* MatSnackBar */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_openvidu_browser__ = __webpack_require__("./node_modules/openvidu-browser/lib/index.js");
...
var VideoSessionComponent = /** @class */ (function () {
    ...
    VideoSessionComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common__["f" /* Location */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_video_session_service__["a" /* VideoSessionService */]])
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["m" /* transition */])('* <=> *', [
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["g" /* group */])([
            Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["i" /* query */])(':enter', [
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["e" /* animate */])('0.4s ease-in-out', Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["l" /* style */])({ opacity: '1' }))
            ], { optional: true }),
            Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["i" /* query */])(':leave', [
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["e" /* animate */])('0.2s cubic-bezier(0.000, 0.900, 0.495, 0.990)', Object(__WEBPACK_IMPORTED_MODULE_0__angular_animations__["l" /* style */])({ opacity: '0' }))
            ], { optional: true }),
        ])
    ])
]);
